...
app.use( json());
// // handling, not making -http.get(localhost: 8080/api/data)
// app.get('/api/data', (request, response) => {
//   response.json({ greeting: "I'm building a server!"})
// });
...
//characters
//GET ALL - http:whatever
//GET ONE - /api/characters/someId
// DELETE ONE - /api/characters/comeId
// Vehicles
